      ...
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-12 pt-4 md:pt-12">
          ...
          <p className="text-gray-600 text-base md:text-lg max-w-2xl mx-auto pb-8">
            A few words from teammates and friends I have collaborated with on projects, coding contests, and campus initiatives.
          </p>
        </div>
            ...
            <div className="bg-white border-4 border-black rounded-3xl py-8 md:py-14 px-6 md:px-8 md:pr-72 lg:pr-72">
              ...
              <div className="md:max-w-[65%]">
                <p className="text-sm md:text-base lg:text-lg mb-6 leading-relaxed">
                  Shivam is the person I call when a problem feels impossible. He breaks it down calmly, finds the right approach, and keeps going until the solution is solid.
                </p>

                <div>
                  <div className="font-bold text-base md:text-lg">Aarav Mehta</div>
                  <div className="text-gray-600 text-sm md:text-base">Project teammate · NIT Raipur</div>
                </div>
              </div>
            </div>
