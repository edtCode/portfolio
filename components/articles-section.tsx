    ...
    <section className="container mx-auto px-4 py-16 md:py-24">
      <div className="max-w-7xl mx-auto">
        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 mb-12">
          <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold">Notes from my learning journey</h2>
          <Button
            variant="outline"
          ...
          <div className="group bg-white border-[3px] border-black rounded-3xl overflow-hidden hover:shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] transition-all duration-300">
            ...
            <div className="p-6 md:p-8">
              <h3 className="text-xl md:text-2xl font-bold mb-4 md:mb-6">
                How I approach a new DSA problem
              </h3>
              <div className="flex items-center gap-3 md:gap-4">
                ...
                <div>
                  <div className="font-bold text-base md:text-lg text-[#0B0B0B]">Shivam Sharma</div>
          ...
          <div className="space-y-6 md:space-y-8">
              ...
              <div className="flex flex-col sm:flex-row">
                ...
                <div className="p-6 md:p-10 flex flex-col justify-center">
                  <h3 className="text-lg md:text-2xl font-bold mb-3 md:mb-4">
                    Patterns that made graph problems easier
                  </h3>
                  <p className="text-gray-600 text-sm md:text-lg leading-relaxed">
                    Practical notes on breaking down problems, choosing patterns, and writing better solutions.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="group bg-white border-[3px] border-black rounded-3xl overflow-hidden hover:shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] transition-all duration-300">
              <div className="flex flex-col sm:flex-row">
                ...
                <div className="p-6 md:p-10 flex flex-col justify-center">
                  <h3 className="text-lg md:text-2xl font-bold mb-3 md:mb-4">
                    Lessons from building projects at college
                  </h3>
                  <p className="text-gray-600 text-sm md:text-lg leading-relaxed">
                    Practical notes on breaking down problems, choosing patterns, and writing better solutions.
                  </p>
